...
# Cargar la clave secreta desde Streamlit Secrets
...
# Al enviar el formulario, agregar el registro a la base de datos
...
# Función para cargar un nombre por su nombre desde Firestore
def loadByName(name):
...
# Barra lateral para buscar, eliminar y actualizar nombres
...
# Mostrar los nombres en un DataFrame
